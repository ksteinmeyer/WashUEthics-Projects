...
public class Auction {
    ...
    public Auction(String name, int incrementAmount, int startingValue, Bidder firstBidder, Bidder secondBidder){
        //constructor creates object and initializes variables inside, it is provided for you
        this.name = name;
        ...
        populateArrays(); //entering starting values into arrays
    }
